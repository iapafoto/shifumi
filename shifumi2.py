...
# === Initialisation MediaPipe Hands (mis à jour) ===

# Configuration du modèle pour le détecteur de landmarks de la main
MODEL_PATH = 'hand_landmarker.task' # Télécharger le modèle depuis https://developers.google.com/mediapipe/solutions/vision/hand_landmarker
...
# Création de l'objet HandLandmarker
...
def calculate_finger_opening(i, hand_landmarks, finger_tips):
    ...
    tip = hand_landmarks[tip_index]  # Coordonnées du bout du doigt
    pt0 = hand_landmarks[0]  # Base de la main (point 0)
    pt9 = hand_landmarks[9]  # Point de référence (point 9)
